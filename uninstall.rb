...
FileUtils.rm File.dirname(__FILE__) + '/public/javascript/qunit.js', js_dir unless File.exists?(js_dir + "qunit.js")
FileUtils.rm File.dirname(__FILE__) + '/public/javascript/qunit_for_rails.js', js_dir unless File.exists?(js_dir + "qunit_for_rails.js")
